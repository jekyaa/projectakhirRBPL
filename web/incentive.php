    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Incentive</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="main.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Incentive</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pt-7 pl-5">
        <div class="col-lg-9 pt-7 pb-lg-7 mx-auto">
            <div class="about-text bg-white p-4 p-lg-5 my-lg-5 text-center">
                <h1 class="mb-3">INCENTIVE</h1>
                <p>Seiring perkembangan zaman, kebutuhan akan 
                            perancang, pengatur, dan pengarah acara pernikahan 
                            mulai menjadi kebutuhan bagi calon mempelai. 
                            Simplemice kini juga hadir sebagai Wedding Planner 
                            sebagai wadah bagi calon pengantin yang meliputi 
                            fungsi Planning (perencanaan), Coordinating 
                            (koordinasi), Controling (pengawasan), Directing 
                            (pengarahan) yang kami rangkum sebagai professional 
                            kerja.</p>
                <div class="row mb-4">
                    <div class="col-6">
