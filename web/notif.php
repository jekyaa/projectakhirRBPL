...
$query = "
    SELECT id,status, Destinasi FROM tour WHERE Email='$user_email'
    UNION
    SELECT id, status, Destinasi FROM pengadaanbarang WHERE Email='$user_email'
    UNION
    SELECT id, status, Destinasi FROM mice WHERE Email='$user_email'
";
...
<head>
    ...
    <style>
        ...
        th {
            background-color: #ff6600; /* Warna oranye dominan */
            color: white;
        }
...
?>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a class="nav-item nav-link active" href="notif.php">
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><?php echo $order['Destinasi']; ?></td>
    ...
    <?php
    // Check for accepted orders to display a notification
    $accepted_orders = mysqli_query($koneksi, "SELECT * FROM tour WHERE Email='$user_email' AND status='Accepted'");
    if (mysqli_num_rows($accepted_orders) > 0) {
        echo "<script>alert('Pesanan anda diterima mohon menunggu konfirmasi!');</script>";
    }
    ?>
